   ...
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="container">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">Getting your music</h2>
                <p class="lead">Music is delivered either by a record label or a distributor. If you’re signed to a
                    label, they’ll take care of getting your music to dic. If you’re independent, you’ll have to
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading">Guidelines for music </h2>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <p class="lead">Welcome to dic for Artists! We’ve created this guide to walk you through setting up
